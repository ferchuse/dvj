	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="../index.php">
				<img src="../img/logo_small.png" class="img-responsive" width="45px">
			</a>
		</div>
			...
			<ul class="nav navbar-nav">
				...
				<?php
					...
					<li class="<?php echo $menu_activo == "clientes" ? "active" : ''; ?>">
						<a href="../clientes/lista_clientes.php">
							<i class="fa fa-users"></i> Clientes
						</a>
					</li>
					<li class="<?php echo $menu_activo == "vendedores" ? "active" : ''; ?>">
						<a href="../catalogos/vendedores.php">
					...
					<li class="dropdown <?php echo $menu_activo == "reportes" ? "active" : ''; ?>">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="../reportes/comisiones.php"><i class="fas fa-dollar-sign"></i> Comisiones</a>
							</li>
						</ul>
					</li>
					<?php
