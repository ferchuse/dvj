...
$consulta = "SELECT SUM(total_ventas) AS total, SUM(efectivo_ventas) AS efectivo FROM ventas";
            ...
            <div class="col-12">
                ...
                <div class="row mt-4">
                    <div class="col-6">
                        <div class="row no-gutters">
                            ...
                            <div class="cantidad text-primary col-4 text-left"><?php echo $fila_productos[0]["total"] ?></div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="row no-gutters">
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="text-success col-1 text-center">$</div>
                                <div class="cantidad text-success col-3 text-left"><?php echo $fila_productos[0]["efectivo"] ?></div>
                            </div>
                            <div class="row no-gutters">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="text-success col-1 text-center">+</div>
                                <div class="text-success col-1 text-center">$</div>
                                <div class="cantidad text-success col-3 text-left">500</div>
                            </div>
                            <div class="row no-gutters">
                                <div class="col-7">Salidas</div>
                                <div class="text-danger col-1 text-center">-</div>
                                <div class="text-danger col-1 text-center">$</div>
                                <div class="cantidad text-danger col-3 text-left">500</div>
                            </div>
                            <div class="row no-gutters">
                                <div class="col-7">Devoluciones en Efectivo</div>
                                <div class="text-danger col-1 text-center">-</div>
                                <div class="text-danger col-1 text-center">$</div>
                                <div class="cantidad text-danger col-3 text-left">1000</div>
                            </div>
                            <div class="total row no-gutters mt-1">
                                <div class="col-7"></div>
                                <div class="col-1 text-center"></div>
                                <div class="col-1 text-center border-top border-secondary">$</div>
                                <div class="cantidad col-3 text-left border-top border-secondary">3000</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="text-danger col-1 text-center">-</div>
                                <div class="text-danger col-1 text-center">$</div>
                                <div class="cantidad text-danger col-3 text-left">2,000,000.00</div>
                            </div>
                            <div class="total row no-gutters mt-1">
                                <div class="col-7"></div>
                                <div class="col-1 text-center"></div>
                                <div class="col-1 text-center border-top border-secondary">$</div>
                                <div class="cantidad col-3 text-left border-top border-secondary">2,000,000.00</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="mensaje col-8">No Hubo Entradas en Efectivo</div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="mensaje col-8">No Hubo Ingresos de Contado</div>
                                <div class="col-4 text-left"></div>
                            </div>
                            <div class="total row no-gutters mt-1">
                                <div class="col-7"></div>
                ...
                <div class="row mt-4">
                    <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="mensaje col-8">No se Registró Ninguna Venta</div>
                                <div class="col-4 text-left"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="mensaje col-8">No Hubo Salidas en Efectivo</div>
                                <div class="col-4 text-left"></div>
                            </div>
                        </div>
                    </div>
