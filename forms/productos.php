				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group ">
								<label for="ganancia_menudeo_porc">Porcentaje de Ganancia :</label>
								<input required type="number" value="25" step=".01" class="form-control" id="ganancia_menudeo_porc" name="ganancia_menudeo_porc">
							</div>
							<div class="form-group ">
								<label for="precio_menudeo">Precio de Venta:</label>
								<input placeholder="PRECIO" type="number" min="0" step=".01" class="form-control" id="precio_menudeo" name="precio_menudeo">
							</div>
							<div class="form-group ">
								<label for="precio_medico">Precio Médico:</label>
								<input placeholder="" type="number" min="0" step=".01" class="form-control" id="precio_medico" name="precio_medico">
							</div>
							<div class="form-group ">
							...
							<div class="form-group ">
								<label for="min_productos">Mínimo:</label>
